    ...
    public class WindowManager : MonoBehaviour
    {
        ...
        public void AddNewItem()
        {
            ...
            if (windows.Count != 0 && windows[windows.Count - 1].windowObject != null)
            {
                ...
                GameObject newWindow = Instantiate(tempWindow, new(0, 0, 0), Quaternion.identity) as GameObject;
                ...
                if (windows[tempIndex].buttonObject != null)
                {
                    ...
                    GameObject newButton = Instantiate(tempButton, new(0, 0, 0), Quaternion.identity) as GameObject;
