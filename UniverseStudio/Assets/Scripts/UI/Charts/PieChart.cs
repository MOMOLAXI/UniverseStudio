	...
	public class PieChart : MaskableGraphic
	{
		...
		protected override void OnPopulateMesh(VertexHelper vh)
		{
			...
			for (int i = 0; i < fa; i++)
			{
				...
				pos0 = prevX;
				pos1 = new(outer * c, outer * s);
				pos2 = new(inner * c, inner * s);
				pos3 = prevY;
		...
		public void AddNewItem()
		{
			...
			if (indicatorParent.childCount != 0)
			{
				...
				GameObject newIndicator = Instantiate(tempIndicator, new(0, 0, 0), Quaternion.identity) as GameObject;
