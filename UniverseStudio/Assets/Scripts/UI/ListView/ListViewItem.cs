    ...
    public class ListViewItem : MonoBehaviour
    {
        ...
        public void PassReferences()
        {
            ...
            { 
                ...
                row0.iconImage.transform.localScale = new(row0Ref.iconScale, row0Ref.iconScale, row0Ref.iconScale);
            }
            ...
            if (row1Ref.rowType == ListView.RowType.Icon) 
            {
                ...
                row1.iconImage.transform.localScale = new(row1Ref.iconScale, row1Ref.iconScale, row1Ref.iconScale);
            }
            ...
            { 
                ...
                row2.iconImage.transform.localScale = new(row2Ref.iconScale, row2Ref.iconScale, row2Ref.iconScale);
            }
