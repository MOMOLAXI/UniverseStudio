...
namespace Michsky.MUIP
{
    public class ListView : MonoBehaviour
    {
        ...
        public void InitializeItems()
        {
            ...
            {
                GameObject go = Instantiate(itemPreset, new(0, 0, 0), Quaternion.identity) as GameObject;
            ...
            if (showScrollbar == false && scrollbar != null) { scrollbar.transform.localScale = new(0, 0, 0); }
            else if (showScrollbar == true && scrollbar != null) { scrollbar.transform.localScale = new(1, 1, 1); }
        }
    }
}