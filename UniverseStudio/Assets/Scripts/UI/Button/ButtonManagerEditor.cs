            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (autoFitContent.boolValue == true)
                    {
                        ...
                        EditorGUILayout.PropertyField(padding, new(" Padding"), true);
                    ...
                    EditorGUILayout.PropertyField(onClick, new("On Click"), true);
                    EditorGUILayout.PropertyField(onDoubleClick, new("On Double Click"), true);
                    EditorGUILayout.PropertyField(onHover, new("On Hover"), true);
                    EditorGUILayout.PropertyField(onLeave, new("On Leave"), true);
                    break;
