        ...
        public void UpdateUI()
        {
            if (autoFitContent == false) 
            {
                ...
                { 
                    ...
                    if (targetRect != null)
                    {
                        targetRect.anchorMin = new(0, 0);
                        targetRect.anchorMax = new(1, 1);
                        targetRect.offsetMin = new(0, 0);
                        targetRect.offsetMax = new(0, 0);
                    }
                }
            }
            ...
            if (disabledLayout != null) { disabledLayout.padding = new(padding.left, padding.right, padding.top, padding.bottom); disabledLayout.spacing = spacing; }
            if (normalLayout != null) { normalLayout.padding = new(padding.left, padding.right, padding.top, padding.bottom); normalLayout.spacing = spacing; }
            if (highlightedLayout != null) { highlightedLayout.padding = new(padding.left, padding.right, padding.top, padding.bottom); highlightedLayout.spacing = spacing; }
            ...
            if (enableIcon == true)
            {
                Vector3 tempScale = new(iconScale, iconScale, iconScale);
