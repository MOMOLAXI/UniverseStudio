...
namespace Michsky.MUIP
{
    ...
    public class HorizontalSelector : MonoBehaviour
    {
        ...
        public void UpdateIndicators()
        {
            ...
            for (int i = 0; i < items.Count; ++i)
            {
                GameObject go = Instantiate(indicatorObject, new(0, 0, 0), Quaternion.identity) as GameObject;
        ...
        public void UpdateContentLayout()
        {
            ...
            if (labelIcon != null)
            {
                labelIcon.transform.localScale = new(iconScale, iconScale, iconScale);
                labelIconHelper.transform.localScale = new(iconScale, iconScale, iconScale);
            }
