...
namespace Michsky.MUIP
{
    ...
    public class UIManagerButton : MonoBehaviour
    {
        ...
        void UpdateButton()
        {
            ...
            {
                if (disabledBackground != null) { disabledBackground.color = highlightedBackground.color = new(UIManagerAsset.buttonAccentColor.r, UIManagerAsset.buttonAccentColor.g, UIManagerAsset.buttonAccentColor.b, UIManagerAsset.buttonDisabledAlpha); }
            ...
            if (buttonManager.enableIcon == true && overrideColors == false)
            {
                ...
                {
                    if (disabledIcon != null) { disabledIcon.color = new(UIManagerAsset.buttonAccentColor.r, UIManagerAsset.buttonAccentColor.g, UIManagerAsset.buttonAccentColor.b, UIManagerAsset.buttonDisabledAlpha); }
            ...
            if (buttonManager.enableText == true)
            {
                if (overrideColors == false)
                {
                    ...
                    {
                        if (disabledText != null) { disabledText.color = new(UIManagerAsset.buttonAccentColor.r, UIManagerAsset.buttonAccentColor.g, UIManagerAsset.buttonAccentColor.b, UIManagerAsset.buttonDisabledAlpha); }
