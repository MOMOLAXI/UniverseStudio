...
namespace Michsky.MUIP
{
    ...
    public class UIManagerToggle : MonoBehaviour
    {
        ...
        void UpdateToggle()
        {
            ...
            onLabel.color = new(UIManagerAsset.toggleTextColor.r, UIManagerAsset.toggleTextColor.g, UIManagerAsset.toggleTextColor.b, onLabel.color.a);
            onLabel.font = UIManagerAsset.toggleFont;
            offLabel.color = new(UIManagerAsset.toggleTextColor.r, UIManagerAsset.toggleTextColor.g, UIManagerAsset.toggleTextColor.b, offLabel.color.a);
