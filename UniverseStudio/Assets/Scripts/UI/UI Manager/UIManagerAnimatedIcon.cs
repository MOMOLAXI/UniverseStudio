    ...
    public class UIManagerAnimatedIcon : MonoBehaviour
    {
        ...
        void UpdateAnimatedIcon()
        {
            ...
            for (int i = 0; i < imagesWithAlpha.Count; ++i)
            {
                ...
                currentAlphaImage.color = new(UIManagerAsset.animatedIconColor.r, UIManagerAsset.animatedIconColor.g, UIManagerAsset.animatedIconColor.b, currentAlphaImage.color.a);
            }
        }
    }
}