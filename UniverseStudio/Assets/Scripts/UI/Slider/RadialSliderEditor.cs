...
namespace Michsky.MUIP
{
    ...
    public class RadialSliderEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            toolbarTabs[0] = new("Content");
            toolbarTabs[1] = new("Resources");
            toolbarTabs[2] = new("Settings");
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    EditorGUILayout.PropertyField(onValueChanged, new("On Value Changed"), true);
                    EditorGUILayout.PropertyField(onPointerEnter, new("On Pointer Enter"), true);
                    EditorGUILayout.PropertyField(onPointerExit, new("On Pointer Exit"), true);
                    break;
            ...
            if (rsTarget.sliderImage != null && rsTarget.indicatorPivot != null && rsTarget.valueText != null)
            {
                ...
                rsTarget.indicatorPivot.transform.localEulerAngles = new(180.0f, 0.0f, rsTarget.SliderAngle);
