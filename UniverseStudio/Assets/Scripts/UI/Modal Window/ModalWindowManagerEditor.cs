        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    EditorGUILayout.PropertyField(onOpen, new("On Open"), true);
                    EditorGUILayout.PropertyField(onConfirm, new("On Confirm"), true);
                    EditorGUILayout.PropertyField(onCancel, new("On Cancel"), true);
                    break;
