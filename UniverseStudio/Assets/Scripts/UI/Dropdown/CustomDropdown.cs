    ...
    public class CustomDropdown : MonoBehaviour, IPointerExitHandler, IPointerEnterHandler, IPointerClickHandler
    {
        ...
        void ProcessModularAnimation()
        {
            if (isOn == true)
            {
                ...
                listRect.sizeDelta = Vector2.Lerp(listRect.sizeDelta, new(listRect.sizeDelta.x, panelSize), Time.unscaledDeltaTime * sizeSmoothness);
            ...
            {
                listCG.alpha -= Time.unscaledDeltaTime * transitionSmoothness;
                listRect.sizeDelta = Vector2.Lerp(listRect.sizeDelta, new(listRect.sizeDelta.x, closeOn), Time.unscaledDeltaTime * sizeSmoothness);
        ...
        public void SetupDropdown()
        {
            ...
            {
                GameObject go = Instantiate(itemObject, new(0, 0, 0), Quaternion.identity) as GameObject;
