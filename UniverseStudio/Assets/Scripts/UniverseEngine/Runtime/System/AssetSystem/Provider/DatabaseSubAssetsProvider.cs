...
namespace Universe
{
	sealed internal class DatabaseSubAssetsProvider : ProviderBase
	{
		public DatabaseSubAssetsProvider(AssetPackageProxy proxy, string providerGuid, AssetInfo assetInfo) : base(proxy, providerGuid, assetInfo)
		{
		}
		public override void Update()
		{
			...
			if (Status == EStatus.Loading)
			{
				...
				{
					Object[] findAssets = UnityEditor.AssetDatabase.LoadAllAssetRepresentationsAtPath(MainAssetInfo.AssetPath);
					List<Object> result = new(findAssets.Length);
