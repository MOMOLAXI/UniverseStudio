...
namespace Universe
{
	...
	public class PackSeparately : IPackRule
	{
		PackRuleResult IPackRule.GetPackRuleResult(PackRuleData data)
		{
			...
			PackRuleResult result = new(bundleName, DefaultPackRule.ASSET_BUNDLE_FILE_EXTENSION);
			return result;
		}
	...
	{
		public static PackDirectory StaticPackRule = new();
	...
	public class PackRawFile : IPackRule
	{
		PackRuleResult IPackRule.GetPackRuleResult(PackRuleData data)
		{
			...
			PackRuleResult result = new(bundleName, DefaultPackRule.RAW_FILE_EXTENSION);
			return result;
		}
