...
namespace Universe
{
    public abstract class BundleLoaderBase
    {
        ...
        /// 所属资源系统
        /// </summary>
        public AssetPackageProxy Proxy { private set; get; }
        ...
        public BundleLoaderBase(AssetPackageProxy proxy, BundleInfo bundleInfo)
        {
            Proxy = proxy;
        ...
        public bool CanDestroy()
        {
            ...
            {
                if (Proxy.CheckBundleDestroyed(bundleID) == false)
                    return false;
            }
        ...
        public void TryDestroyAllProviders()
        {
            ...
            // 销毁所有Providers
            {
                ...
                Proxy.RemoveBundleProviders(_providers);
                _providers.Clear();
            }
        }
